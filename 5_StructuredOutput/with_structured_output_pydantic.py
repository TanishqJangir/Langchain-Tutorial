...
class Review(BaseModel):
    ...
    sentiment : Literal["Positive","Negative","Neutral"] = Field(description="Sentiment of the review : Positive,Negative,Neutral")
    rating : float = Field(description="Rating of the review : 1-5")
...
result = structured_output.invoke("""I recently upgraded to the Samsung Galaxy S24 Ultra, and I must say, it's an absolute powerhouse! The Snapdragon 8 Gen 3 rocessor makes everything lightning fast—whether I'm gaming, multitasking, or asts a full dav even with heavv use. and the 45W fast charging is a lifesaver.
